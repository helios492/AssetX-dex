            ...
            {walletConnected ? (
                ...
                <MainButton
                  ...
                  content={
                    <div className="flex flex-col text-gray-300">
                      <div className="font-[500]">{reduceAddress(walletAccount?.name,5,0) || "Account"}</div>
                      <div className="text-small">{reduceAddress(walletAccount?.address, 3, 3)}</div>
                    </div>
                  }
                  className="pl-2 py-1 rounded-xl bg-gradient-to-r"
                />
              ...
              <div onClick={() => setIsConnectWallet(true)}>
                <MainButton
                  imgURL="/icons/wallet.png"
                  imgURLDark="/icons/wallet-white.png"
                  content={<div className="text-gray-300 text-wrap">Connect</div>}
                  className="pl-2 py-1 rounded-xl bg-gradient-to-r"
                />
              </div>
            )}
