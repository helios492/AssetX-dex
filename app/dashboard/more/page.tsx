...
const More = () => {
  ...
  return (
    <div className="flex flex-col justify-start min-w-[360px] items-center h-screen px-[10%] pt-[20%] pb-[30%] gap-3 text-[var(--text-maincolor)] dark:text-[#120038] overflow-auto">
      ...
      <div className="w-full p-0.5 bg-gradient-to-br from-[#5100FE] to-[#B4D2FF] dark:bg-gradient-to-b dark:from-[#5100FE] dark:to-[#5100FE] rounded-xl">
        <div className="flex flex-col gap-5 w-full h-full px-7 py-6 bg-[#220068] dark:bg-[#E8E8E8] rounded-xl">
          ...
          >
            <div className="w-full h-full flex flex-row justify-center items-center py-5 bg-gradient-to-b from-[#5100FE] to-[#32009C] rounded-xl text-[var(--text-maincolor)] hover:text-fuchsia-50 dark:text-white dark:hover:text-[var(--text-maincolor)] text-lg cursor-pointer">
      ...
      <div className="w-full p-0.5 bg-gradient-to-br from-[#5100FE] to-[#B4D2FF] dark:bg-gradient-to-b dark:from-[#5100FE] dark:to-[#5100FE] rounded-xl ">
        <div className="flex flex-col gap-4 w-full h-full px-7 py-6 bg-[#220068] dark:bg-[#E8E8E8] rounded-xl">
          ...
          <div className="p-0.5 bg-gradient-to-br from-[#5100FE] to-[#B4D2FF] dark:bg-gradient-to-t dark:from-[#E8E8E8] rounded-xl">
            <div
              className="w-full h-full flex flex-row justify-center items-cente px-16 py-5 bg-gradient-to-b from-[#5100FE] to-[#32009C] rounded-xl text-[var(--text-maincolor)] hover:text-white dark:text-white dark:hover:text-[var(--text-maincolor)] text-lg cursor-pointer"
              onClick={() => setIsSettingClicked(true)}
            >
          ...
          <div className="flex flex-row justify-center items-center gap-3 px-4">
            <p className="text-white dark:text-[#120038] text-xl font-bold whitespace-nowrap">
              Dark / Light Mode
            </p>
            <div className="min-w-20 p-0.5 bg-gradient-to-br from-[#5100FE] to-[#B4D2FF] rounded-3xl">
              ...
              >
                <div className="flex dark:hidden justify-end items-center h-7 w-7 bg-gradient-to-br from-[#5100FE] to-[#B4D2FF] rounded-full ">
                  <div className="h-6 w-5 bg-[#5100FE] rounded-[100%]"></div>
                </div>
                <div className="hidden dark:flex rounded-full justify-end items-center h-7 w-7 bg-gradient-to-b from-[#FED500] to-[#FF8A00] "></div>
              </div>
            </div>
          </div>
        </div>
